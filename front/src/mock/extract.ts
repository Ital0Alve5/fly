...
const ExtractHistory = ref<ExtractItem[]>([
  {
    ...
    value: (245.5).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }),
    miles: 4200,
    description: 'GRU->SDU',
    type: 'SAÍDA',
  },
  {
    ...
    value: (189.9).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }),
    miles: 0,
  ...
  },
  {
    ...
    value: (175.2).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }),
    miles: 3504,
    description: 'BSB->CGH',
    type: 'SAÍDA',
  },
